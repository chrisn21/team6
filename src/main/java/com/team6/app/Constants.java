...
public final class Constants {
	...
	public static final String LEADERBOARD_PATH_FILE 		= "user/leaderboard";
	...
	public static final String QUIZZES_PATH_FILE 			= "quiz/quizzes";
	public static final String QUIZ_RESULT_PATH_FILE		= "quiz/result";
	
	public static final String USER_COLLECTION_NAME 		= "User";
	public static final String CHARACTER_COLLECTION_NAME 	= "Character";
